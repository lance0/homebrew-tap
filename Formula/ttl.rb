class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "6169cd0460613391dd62598c9e65308e5942fb1c2fee51d37b61f7c0ec294b10"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "e992403c88cf35feccd2afce1145a91c8be4f42ed8674b5bc531cc80e98eefca"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "f4cb454664389b88072b3f1f957d27e6a7aa82fa0e5cff15e02e063953e00e7c"
    end
  end
