class Xfr < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "9d4592b045f0661f526e9025cc2da8ad13676cd3068cd14c504f2d1ee0474dbe"
    end
    on_intel do
  ...
  on_linux do
    on_intel do
      ...
      sha256 "42716e6a9019369fa2a9ef2ed5c0eebf541a3ae17f5cec8aaaf9475fe63b2f65"
    end
    on_arm do
      url "https://github.com/lance0/xfr/releases/download/v#{version}/xfr-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "6e0b423baa160f299b9d5086668b1561e5c51966908cbd6d97dd33579666e4cf"
    end
  end
