class Xfr < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "5847a81b21ef748d4e91d0115de98c806952f3241bfc4bfa54ebc8cf512fec3e"
    end
    on_intel do
  ...
  on_linux do
    on_intel do
      ...
      sha256 "c5f3357586f9d88c53108fc585dd62cf1b7f7a53dca8b2dd4898913ca4359ed1"
    end
    on_arm do
      url "https://github.com/lance0/xfr/releases/download/v#{version}/xfr-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "11b0f42122b8d01b371ba0d82a99895f5f078487258a969b69aef2e32c8c63fd"
    end
  end
