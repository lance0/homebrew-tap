class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "bdc41a237b12c84ee9601481f0e79568e79943daf55621488e7867dbc6ac6f3e"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "a67bd37e1a1507bb9e4eb262697a2118eb478148d483f18280a4360a5afece5c"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "5ef79f899d83fb9b037e36eff08e44f0265ffe065a151a560aca3f3d2a6e1328"
    end
  end
