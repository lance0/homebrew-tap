class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "f65e76a8a3643754f805a79a0acc150d3c5b8b6f3805da631a9c7c65d5a66b58"
    end
    on_intel do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-x86_64-apple-darwin.tar.gz"
      sha256 "b494632d373bba86db0537ffb1f098b66d642e958936127166d70ef43e22c9bd"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "c5de2aeb975a6316b19a35b6be193ea73259a312d690c8a49de562d62d199dec"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "73f6a54f00e395642f588591ed5e7f338ee4369409f6cdca0eb9c6bc07725b7c"
    end
  end
