class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "e3eddb062fa002a257781bb69e8727c738ca447d6116463918bd3b4c237125b7"
    end
    on_intel do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-x86_64-apple-darwin.tar.gz"
      sha256 "da5f255396d551f4542c2da3ea9a5835a0375d124354df23d740cdd32e8b9246"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "2384077ba7e431ed571ec5629a9ee768666516f64d294547f512c30fc256c8a5"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "c9e1c21183ca5da57f733f8ae3f79863967eec029130f213e4609a0c3d2c4335"
    end
  end
