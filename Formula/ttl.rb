class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "31f2a1ff2f63cea5e8f5ecde143e7b3711b3a0eabc8217e18389260d8bad5730"
    end
    on_intel do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-x86_64-apple-darwin.tar.gz"
      sha256 "850c54517919c6642aefeb89a8faa95b416268052da79d993bd0c967c14240a9"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "a54e4f76ba98f0d1c382e53031f7155087af015929d5314b731b14da85473316"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "805dc9cdf16ce6f5ca3b44af995a78276d7457a62c68b0d1b094179271b71bba"
    end
  end
