class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "402f17a5f98a0dd0829508c82d76a607de0bfeb9467a330b9bc7ada015b38486"
    end
    on_intel do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-x86_64-apple-darwin.tar.gz"
      sha256 "449b44334df8f83b8377ca9e4c861f94a902b773f0337ec5b04ad8f97d0cea6b"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "7bb9fa63e19f85403bb8403f9524b05a629d1e0722d8119f12b47d1c0d330451"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "8e721296322147b9756f0e737231067b5b667be26972b00c368ad68f9711010f"
    end
  end
