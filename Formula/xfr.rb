class Xfr < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "0cd2a13062ef5bb5861bcae161ff9593f62c48e822a419e0a75eea39ebd23914"
    end
    on_intel do
  ...
  on_linux do
    on_intel do
      ...
      sha256 "c8d33180cbd2ed31deb0a409309395c6425ed7cb5726e7d84e9c48bf5dbf3ad6"
    end
    on_arm do
      url "https://github.com/lance0/xfr/releases/download/v#{version}/xfr-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "5765548de33599d34cf730d0cdaaf9da3dc069ae1e005319f5ee4d032ae7d0ba"
    end
  end
