class Xfr < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "39c6ee07a6372b893c4b578be697b1aec4ae24da9da0c8b52fa940cd5ebd2ae1"
    end
    on_intel do
  ...
  on_linux do
    on_intel do
      ...
      sha256 "4c4e986264c85a18b7f136c5ab22e33c323f51dfd30fd43db067ca9691344db3"
    end
    on_arm do
      url "https://github.com/lance0/xfr/releases/download/v#{version}/xfr-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "6c179cc555b06566b4ad6188a8b01a53a6a0d8f4d9a40ceb5a4b622be91773db"
    end
  end
