class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "6435e4554e5b10f7eac169192d1ac5e79df46925b05d2caab5c296ee60ea5b1d"
    end
    on_intel do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-x86_64-apple-darwin.tar.gz"
      sha256 "c8a2dd427f2cff766efb4e3b48cd2eeba38719a5359c8c1bebaa7e7fc211efb5"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "9652eeb6dc0f5e51ddbbc38a6ee829b2d5eccaeb0b7a9101a8864f5f1ece9b94"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "d8b77fe1682743d30cd4de20192a1ac479ffd1ff2f7ccf4b11b6658f3638875b"
    end
  end
