class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "d5d9492494a145a15132b7b70a9d05a89ce5b82051888dbe12e124e60bc82f8a"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "5e71f1f1dc936f6d610343fc640911adeaede8b94620b1d22f6d834938f4fe1e"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "80ba048ff286f3a7058fd5496f9d1544051ffe39c31b5cca9afd6c4514e93f4d"
    end
  end
