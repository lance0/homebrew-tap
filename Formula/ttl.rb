class Ttl < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "11d852976ecddeb23dadc3afa28e7bef5c3e2ebe0887772253f77c778606a1bd"
    end
    on_intel do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-x86_64-apple-darwin.tar.gz"
      sha256 "75f83fc507f9a4e8b7c270ad9b16b8c306f2477f49ebf42cd30304342e33e8d6"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "2f1f76a7a350ad0f966f3418cf79d3c0ca00efecb50c7790c51cff29d7e0b20f"
    end
    on_arm do
      url "https://github.com/lance0/ttl/releases/download/v#{version}/ttl-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "aeee475029d3d50eb2f780461009a9105d22d166c0dd609209362f7f020885ee"
    end
  end
